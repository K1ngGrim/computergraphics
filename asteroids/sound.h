...
static const size_t soundCount = 13;

class Sound {
  const char * file_names[soundCount] = {"sound/fire.wav",
                                 "sound/extraShip.wav",
                                 "sound/bangSmall.wav",
...
public:
  ...
  static constexpr size_t LOOP = 10;
  static constexpr size_t BANG_SHIP = 11;
  static constexpr size_t GAME_OVER = 12;
